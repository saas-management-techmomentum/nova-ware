...
const AboutPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      {/* Header */}
      <header className="relative z-10 bg-gradient-to-r from-slate-900/90 to-slate-800/90 backdrop-blur-sm py-16 px-6 border-b border-slate-700/50">
      ...
      <main className="flex-1 relative z-10">
                ...
                <Card key={index} className="bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 group">
                  <CardContent className="p-6 text-center">
                    <div className="mb-4 flex justify-center">
                      <div className="p-3 bg-slate-700/50 rounded-full group-hover:bg-slate-700 transition-colors duration-300">
                        {metric.icon}
                      </div>
                    </div>
        ...
        {/* CTA Section */}
        <section className="bg-gradient-to-r from-slate-900/90 to-slate-800/90 backdrop-blur-sm py-16 px-6 text-white border-t border-slate-700/50">
