          ...
          {bestSellers.length > 0 ? (
            <div className="space-y-3">
              {bestSellers.slice(0, 5).map((item, index) => (
                <div key={item.id} className="flex items-center justify-between p-3 bg-slate-700/30 rounded-lg border border-slate-600/30">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-slate-400">{item.currentStock} in stock</p>
                  </div>
                </div>
              ))}
            </div>
